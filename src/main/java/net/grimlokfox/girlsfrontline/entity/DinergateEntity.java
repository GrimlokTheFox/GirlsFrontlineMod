...
public class DinergateEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_team = SynchedEntityData.defineId(DinergateEntity.class, EntityDataSerializers.INT);
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public DinergateEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GflmodModEntities.DINERGATE.get(), world);
	}

	public DinergateEntity(EntityType<DinergateEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 2;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_team, 4);
	}
	...
	public static void init() {
		SpawnPlacements.register(GflmodModEntities.DINERGATE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
