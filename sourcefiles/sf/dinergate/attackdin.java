...
public class DinergateAttack {
	public static final AnimationDefinition attack = AnimationDefinition.Builder.withLength(0.5417F)
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(6.52F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("Tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.2917F, KeyframeAnimations.degreeVec(8.33F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5417F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		...
		.addAnimation("GunPart", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.2083F, KeyframeAnimations.degreeVec(2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.2917F, KeyframeAnimations.degreeVec(5.27F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("GunPart", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, -0.32F, -0.62F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, 0.0F, -2.3F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5417F, KeyframeAnimations.posVec(0.0F, 0.0F, -0.3F), AnimationChannel.Interpolations.CATMULLROM)
		))
		...
		.addAnimation("FrontLegL", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.375F, KeyframeAnimations.posVec(0.0F, -0.6F, 0.0F), AnimationChannel.Interpolations.LINEAR),
