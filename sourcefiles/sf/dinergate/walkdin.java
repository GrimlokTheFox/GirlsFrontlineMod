...
public class DinergateWalk {
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(0.625F).looping()
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.375F, KeyframeAnimations.degreeVec(-9.36F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("Gun", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(7.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.0833F, KeyframeAnimations.degreeVec(9.86F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.2083F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.375F, KeyframeAnimations.degreeVec(-5.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.625F, KeyframeAnimations.degreeVec(7.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		...
		.addAnimation("GunPart", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(12.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.1667F, KeyframeAnimations.degreeVec(-1.22F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("GunPart", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 1.0F, -4.3F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.625F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.7F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("BackLegL", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.125F, KeyframeAnimations.degreeVec(-15.69F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("BackLegL", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.125F, KeyframeAnimations.posVec(0.0F, 0.39F, -0.01F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 1.0F, 0.6F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("FrontLegL", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.125F, KeyframeAnimations.degreeVec(8.72F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("FrontLegL", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.125F, KeyframeAnimations.posVec(0.0F, 1.2F, 0.49F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 0.5F, -1.3F), AnimationChannel.Interpolations.CATMULLROM),
